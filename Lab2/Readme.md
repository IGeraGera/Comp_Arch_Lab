...
Για βελτιστοποίηση του κόστους προς την απόδοση θα μπορούσε να χρησιμοποιήσουμε Associativity 2 της Dcache καθώς η διαφορά απο το 4 είναι πολύ μικρή. Αυτό έχει ως αποτέλεσμα το κόστος να γίνει **929792**.
